  ...
  return (
    <div className="relative py-12 bg-white overflow-hidden">
      <div className="mx-auto max-w-7xl px-6 lg:px-8 relative z-10">
        <div className="group relative rounded-[3rem] bg-primary-900 px-6 py-10 sm:px-16 md:pt-14 md:pb-14 shadow-2xl shadow-primary-900/30 text-center overflow-hidden">
          ...
          <div className="relative z-10">
            ...
            <div className="flex flex-col sm:flex-row items-center justify-center gap-3">
              <button
                ...
                className="group/btn w-full sm:w-auto rounded-full bg-white px-8 py-3 text-sm font-bold text-primary-900 shadow-xl transition-all hover:scale-105 hover:bg-primary-50 active:scale-95 flex items-center justify-center gap-2"
              >
              ...
              <button className="w-full sm:w-auto rounded-full border border-white/20 bg-white/5 px-8 py-3 text-sm font-bold text-white backdrop-blur-sm transition-all hover:bg-white/10 hover:border-white/40">
                Talk to Support
              </button>
            </div>
          </div>
